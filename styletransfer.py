...
https://colab.research.google.com/drive/1lLPmYE2WRPcrTdr6YLa3W5gmeaUdYw2i
...
def execute(input_img, style_img, epochs):
    # Load and display texture image
    #image_C = tf.keras.preprocessing.image.load_img("newyork.jfif", target_size = image_shape)
    
    image_C = tf.keras.preprocessing.image.load_img(input_img, target_size = image_shape)
    ...
    tf.keras.preprocessing.image.save_img(path = 'Output.jpg', x = img_C[0,:,:,:])
    
    #########################################################################################################
    
    # Load and display perceptual image
    #image_P = tf.keras.preprocessing.image.load_img("starrynight.jfif", target_size = image_shape)
    image_P =tf.keras.preprocessing.image.load_img(style_img, target_size = image_shape)
    ...
    global activation_C, activation_P
    ...
    if blank == True:
      ...
      product = tf.keras.preprocessing.image.load_img("Output.jpg", target_size = image_shape)
    ...
    tf.keras.preprocessing.image.save_img(path = 'Output.jpg', x = prod[0,:,:,:])
